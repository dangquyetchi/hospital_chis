  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <p><strong>Tiền thuốc:</strong> <span id="popupPricePrecription"></span></p>
...
<script>
    function openPaymentPopup(paymentId, patientName, birthDate, pricePrescription) {
        document.getElementById('popupPatientName').innerText = patientName;
        document.getElementById('popupBirthDate').innerText = birthDate;
        document.getElementById('popupPricePrecription').innerText = pricePrescription;
    ...
    $.ajax({
        url: '/process-payment-prescription',
        type: 'POST',
        data: {
            _token: "{{ csrf_token() }}",
